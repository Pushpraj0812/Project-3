		...
		<form action="<%=ORSView.TIMETABLE_LIST_CTL%>" method="post">
			...
			<center>
				<h1 class="text-primary font-weight-bold pt-3">
					<font color="black"> Time-Table List 
				</h1>
				</font>
			</center>
			</br>
				...
				<div class="col-sm-3">
					<%
						HashMap map = new HashMap();
							...
							map.put("Maths", "Maths");
							String htmlList = HTMLUtility.getList("subName", dto.getSubName(), map);
					%>
					<%=htmlList%>
					<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("subName", request)%></font></br>
				</div>
