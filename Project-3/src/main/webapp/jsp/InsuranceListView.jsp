		...
		<div class="row">
			...
			<div class="col-sm-2">
				...
				<input type="text" name="policyNumber" class="form-control"
					...
					value="<%=ServletUtility.getParameter("policyNumber", request)%>">

			</div>

			<div class="col-sm-2">

				<input type="text" name="policyHolderName" class="form-control"
		...
		<div class="table-responsive">
			...
			<table class="table table-bordered table-dark table-hover">
				...
				<tr style="background-color: #8C8C8C">
					...
					<th width="10%"><input type="checkbox" id="select_all">Select
						All</th>

					<th class="text">S.NO</th>
					<th class="text">Policy Number</th>
					<th class="text">Policy Holder</th>
					<th class="text">Expiry Date</th>
				...
				<tr>
					...
					<td class="text"><%=dto.getPolicyNumber()%></td>

					<td class="text"><%=dto.getPolicyHolderName()%></td>

					<td class="text"><%=DataUtility.getDateString(dto.getExpiryDate())%></td>

					<td class="text"><%=dto.getInsuranceStatus()%></td>
