			...
			<div class="row">
				...
				<div class="col-sm-2">
					...
					<input type="text" name="driverName" placeholder="Driver Name"
						class="form-control"
						value="<%=ServletUtility.getParameter("driverName", request)%>">
				...
				<div class="col-sm-2">
					...
					<input type="text" name="vehicleType" placeholder="Vehicle Type"
						class="form-control"
						value="<%=ServletUtility.getParameter("vehicleType", request)%>">
				...
				<div class="col-sm-3">
					...
					<input type="submit" class="btn btn-primary" name="operation"
						...
						value="<%=TransportListCtl.OP_RESET%>">
				...
				<table class="table table-bordered table-dark table-hover">
					...
					<thead>
						...
						<tr style="background-color: #8C8C8C">
							...
							<th class="text">Transport ID</th>

							<th class="text">Vehicle Number</th>

							<th class="text">Driver Name</th>
					...
					<tbody>
						...
						<tr>
							...
							<td class="text"><%=dto.getTransportId()%></td>

							<td class="text"><%=dto.getVehicleNumber()%></td>

							<td class="text"><%=dto.getDriverName()%></td>

							<td class="text"><%=dto.getVehicleType()%></td>

							<td class="text"><%=dto.getTransportStatus()%></td>

							<td class="text"><a href="TransportCtl?id=<%=dto.getId()%>">Edit</a>
							</td>
			...
			<table width="100%">
				...
				<tr>
					...
					<td><input type="submit" name="operation"
						class="btn btn-warning" value="<%=TransportListCtl.OP_PREVIOUS%>"
						<%=pageNo > 1 ? "" : "disabled"%>></td>

					<td><input type="submit" name="operation"
						class="btn btn-primary" value="<%=TransportListCtl.OP_NEW%>">

					</td>

					<td><input type="submit" name="operation"
						class="btn btn-danger" value="<%=TransportListCtl.OP_DELETE%>">

					</td>

					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning" value="<%=TransportListCtl.OP_NEXT%>"
