...
.input-group-addon {
	...
	/* Adds a shadow around input box (Bootstrap style). 
	9px => horizontal shadow; 8px => vertical shadow; 7px => blur; #001a33 => shadow color (dark blue)
	*/
}

.grad { /* Login box colour */
...
.p4 { /* Sets a background image coming from your JSP: */
