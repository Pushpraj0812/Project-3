...
public class GetMarksheetCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		log.debug("GetMarksheetCtl validate start");
		...
		log.debug("GetMarksheetCtleet validate start");
	...
	protected BaseDTO populateDTO(HttpServletRequest request) {
		...
		log.debug("GetMarksheetCtlt populateDTO start");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("GetMarksheetCtlt doGet start");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("GetMarksheetCtlt doPost start");
		...
		ServletUtility.forward(getView(), request, response);
		log.debug("GetMarksheetCtlt doPost end");
	}
