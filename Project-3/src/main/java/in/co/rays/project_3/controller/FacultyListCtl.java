...
public class FacultyListCtl extends BaseCtl {
	...
	protected void preload(HttpServletRequest request) {
		...
		log.debug("FacultyListCtl preload start");
		...
		log.debug("FacultyListCtl preload end");

	}

	protected BaseDTO populateDTO(HttpServletRequest request) {

		log.debug("FacultyListCtl populateDTO start");
		...
		log.debug("FacultyListCtl populateDTO end");
		return dto;
