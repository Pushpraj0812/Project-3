...
public class SubjectListCtl extends BaseCtl {
	...
	protected void preload(HttpServletRequest request) {
		...
		log.debug("SubjectListCtl preload start");
		...
		log.debug("SubjectListCtl preload end");
	}

	protected BaseDTO populateDTO(HttpServletRequest request) {

		log.debug("subjectctl populate bean start");
		...
		log.debug("SubjectListCtl populateDTO end");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("subjectctl do get start");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("subjectctl dopost start");
		...
		log.debug("subjectctl do post end");
	}
