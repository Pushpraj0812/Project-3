...
public class CollegeCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		log.debug("CollegeCtl Validate method start");
		...
		log.debug("CollegeCtl Validate method end");
	...
	protected BaseDTO populateDTO(HttpServletRequest request) {
		...
		log.debug("CollegeCtl populateDTO start");
		...
		log.debug("CollegeCtl populateDTO end");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("CollegeCtl doget start");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("CollegeCtl dopost start");
		...
		log.debug("CollegeCtl dopost end");
	}
