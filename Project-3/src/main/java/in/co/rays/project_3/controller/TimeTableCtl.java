...
public class TimeTableCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		log.debug("TimeTableCtl validate start");
		...
		log.debug("TimeTableCtl validate end");
	...
	protected BaseDTO populateDTO(HttpServletRequest request) {
		...
		log.debug("TimeTableCtl populate start");
		...
		log.debug("TimeTableCtl populate end");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("TimeTableCtl do get start");
		...
		log.debug("TimeTableCtl doget end");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("TimeTableCtl dopost start");
		...
		ServletUtility.forward(getView(), request, response);
		log.debug("TimeTableCtl dopost end");
	}
