...
public class CollegeListCtl extends BaseCtl {
	...
	protected void preload(HttpServletRequest request) {
		...
		log.debug("CollegeListCtl preload start");
		...
		log.debug("CollegeListCtl preload end");
	}

	protected BaseDTO populateDTO(HttpServletRequest request) {

		log.debug("collegeListCtl populateDTO start");
		...
		log.debug("collegeListCtl populateDTO end");
