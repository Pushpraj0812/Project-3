...
public class MarksheetListCtl extends BaseCtl {
	...
	protected void preload(HttpServletRequest request) {
		...
		log.debug("MarksheetListCtl preload start");
		...
		log.debug("MarksheetListCtl preload end");
	}

	@Override
	protected BaseDTO populateDTO(HttpServletRequest request) {
		
		log.debug("MarksheetListCtl populateDTO start");
		...
		log.debug("MarksheetListCtl populateDTO end");
		return dto;
	}
