...
public class ForgetPasswordCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		log.debug("ForgetPasswordCtl validate start");
	...
	protected BaseDTO populateDTO(HttpServletRequest request) {
		...
		log.debug("ForgetPasswordCtl populateDTO start");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("ForgetPasswordCtl doGet start");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("ForgetPasswordCtl doPost start");
		...
		log.debug("ForgetPasswordCtl doPost end");
